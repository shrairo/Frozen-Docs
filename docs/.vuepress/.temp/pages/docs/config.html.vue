...
<p>此为剩余的配置项，可参照说明与你的需求自行修改，如果你项开箱即用，请参照<a href="https://icebook.shrairo.top/config.html#%E6%8E%A8%E8%8D%90%E9%85%8D%E7%BD%AE" target="_blank" rel="noopener noreferrer">推荐配置</a></p>
<table>
<thead>
<tr>
<th>配置项</th>
...
<p>Binder对于墓碑的体验至关重要，所以Binder冻结和临时解冻必须二选一，也就是说必须且仅能启用一个，如果你选择临时解冻，那你需要刷入Rekernel/Nkbinder模块。具体请参照<a href="https://icebook.shrairo.top/get-started.html#%E4%BD%BF%E7%94%A8%E8%AF%B4%E6%98%8E" target="_blank" rel="noopener noreferrer">快速开始</a></p>
</div>
