 ...
 * ```
 */
declare function objectMap<K$1 extends string, V, NK extends PropertyKey = K$1, NV = V>(obj: Record<K$1, V>, fn: (key: K$1, value: V) => [NK, NV] | undefined): Record<NK, NV>;
/**
 ...
 * ```
 */
declare function omit<T extends object = object, K$1 extends keyof T = keyof T>(obj: T, keys: readonly K$1[]): Omit<T, K$1>;
/**
 ...
 * ```
 */
declare function pick<T extends object = object, K$1 extends keyof T = keyof T>(obj: T, keys: K$1[]): Pick<T, K$1>;
/**
 * Deep merge
 *
...
//#endregion
//#region src/throttle-debounce.d.ts
/**
 * Throttle Options
 * @category Types
 */
